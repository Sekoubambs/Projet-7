...
$films = [
        ...
        [
            "Nom"=> "10 jours encore sans maman",
            ...
            "image" => "10_jours_encore_sans_maman_affiche.jpg",
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/VRDglZvHa-8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
        ] ,

        [
            "Nom"=> "65 - la Terre d'avant",
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/RF4pH6Xsorc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],


        [
            "Nom"=> "Ailleurs si j'y suis",
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/iYuNRV0NyHg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
        ...
        [
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/pyRhXe13Whw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
        ...
        [
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/sRLz3-gcjgg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],


        [
            "Nom"=> "Donjons & Dragons : L'Honneur des voleurs",
            "date de sortie" => "12/04/2023",
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/eRcy28HBdmw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
        ...
        [
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/YecNA3DW334" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
        ...
        [
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/JjBZ2iEBcxM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],

        [
            "Nom"=> "La Chambre des merveilles",
            "date de sortie" => "15/03/2023",
            ...
            "image" => "ressources/La_Chambrre_des_merveilles/La_Chambrre_des_merveilles_affiche.jpg",
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/xXBhqEbpt1g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
        ...
        [
            ...
            "image" => "ressources/La_Petite_sirene/La_Petite_sirene_affiche.jpg",
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/J5VvzJmiqJc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],

        [
            "Nom"=> "La Plus belle pour aller danser",
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/tinMJbzUWgU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],

        [
            "Nom"=> "La Vie pour de vrai",
            "date de sortie" => "19/04/2023",
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/jLJquRF4nNg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],

        [
            "Nom"=> "Le Royaume de Naya",
            "date de sortie" => "29/03/2023",
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/dVHZ-q2aLmY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],

        [
            "Nom"=> "Les Aventures de Ricky",
            "date de sortie" => "12/04/2023",
            ...
            "image" => "ressources/Les_Aventure_de_Ricky/Les_Aventure_de_Ricky_affiche.jpg",
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/BETFXlWV9ac" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
        ...
        [
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/LRUrVzW035w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
        ...
        [
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/0RsvBSFm938" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],

        [
            "Nom"=> "Les Trois Mousquetaires: D'Artagnan",
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/a_OUHJziaoE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],

        [
            "Nom"=> "Mon chat et moi, la grande aventure de Rroû",
            "date de sortie" => "05/04/2023",
            "realisateur" => "Guillaume Maidatchevsky",
            "durée" => "83",
            "genre" => "Aventure, Famille",
            "synopsis" => "Rroû est un chaton vif et curieux qui découvre la vie sur les toits de Paris. Son destin bascule lorsque Clémence, dix-ans, l'adopte et l'emmène dans sa maison de campagne au cœur des montagnes. Débute alors une extraordinaire aventure pour Clémence et Rroû, qui vont grandir ensemble, croiser la route de la mystérieuse Madeleine et vivre une merveilleuse histoire qui va les transformer à tout jamais.",
            "image" => "ressources/Mon_chat_et_moi_la_grande_aventure_de_Rrou/Mon_chat_et_moi_la_grande_aventure_de_Rrou_affiche.jpg",
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/k1OZ8bsMlMU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
        ...
        [
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/PaNkAPIUvpA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],

        [
            "Nom"=> "Princes et princesses : le spectacle au cinéma",
            "date de sortie" => "05/04/2023",
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/zFwvu-iz4eU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
        ...
        [
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/CWh6fsXY5xk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],

        [
            "Nom"=> "Shazam! La Rage des Dieux",
            "date de sortie" => "29/03/2023",
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/sDm4nRYv7dI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
        ...
        [
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/GtJX3gJInig" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],

        [
            "Nom"=> "Super Mario Bros, le film",
            "date de sortie" => "05/04/2023",
            ...
            "image" => "ressources/Super_Mario_Bros_le_film/Super_Mario_Bros_le_film_affiche.jpg",
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/732LtFVX6eU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',

        ],

        [
            "Nom"=> "Sur les chemins noirs",
            "date de sortie" => "22/03/2023",
            ...
            "bande-annonce" => '<iframe width="560" height="315" src="https://www.youtube.com/embed/mOVf8g_XhwE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>',
...
foreach ($films as $film) {
      ...
      <div class="card">
        ...
        <img class="card-img"  src=" <?php echo  $film['image']; ?>" alt="">
        <p>Réalisateur : <?php echo $film['realisateur']; ?></p>
        <p>Durée : <?php echo $film['durée']; ?> minutes</p>
        <p>Genre : <?php echo $film['genre']; ?></p>
        <p>Synopsis : <?php echo $film['synopsis']; ?></p>
        <p>Date de sortie : <?php echo $film['date de sortie']; ?></p>
        <div class= "b-a"><?php echo $film['bande-annonce']; ?></div>
